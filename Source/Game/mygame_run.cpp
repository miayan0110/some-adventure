...
void CGameStateRun::OnMove()							// 移動遊戲元素
{
	...
	if (phase == 3
		...
		&& character.Top() + character.Height() / 2 >= chest_and_key.Top()
		&& character.Top() + character.Height() / 2 <= chest_and_key.Top() + chest_and_key.Height()) {
	...
	if (phase == 5
		...
		&& character.Top() + character.Height() / 2 >= door[0].Top()
		&& character.Top() + character.Height() / 2 <= door[0].Top() + door[0].Height()) {
		door[0].SelectShowBitmap(1);
	}
	if (phase == 5
		&& character.Left() + character.Width() / 2 >= door[1].Left()
		&& character.Left() + character.Width() / 2 <= door[1].Left() + door[1].Width()
		&& character.Top() + character.Height() / 2 >= door[1].Top()
		&& character.Top() + character.Height() / 2 <= door[1].Top() + door[1].Height()) {
		door[1].SelectShowBitmap(1);
	}
	if (phase == 5
		&& character.Left() + character.Width() / 2 >= door[2].Left()
		&& character.Left() + character.Width() / 2 <= door[2].Left() + door[2].Width()
		&& character.Top() + character.Height() / 2 >= door[2].Top()
		&& character.Top() + character.Height() / 2 <= door[2].Top() + door[2].Height()) {
