...
void CGameStateRun::OnInit()  								// 遊戲的初值及圖形設定
{
	...
	/*lives*/
	lives[0].LoadBitmapByString({
		"resources/pacman/pacman_towardL_1.bmp"
		}, RGB(255, 255, 255));
	lives[0].SetTopLeft(16, 550);

	lives[1].LoadBitmapByString({
		"resources/pacman/pacman_towardL_1.bmp"
		}, RGB(255, 255, 255));
	lives[1].SetTopLeft(46, 550);

	lives[2].LoadBitmapByString({
		"resources/pacman/pacman_towardL_1.bmp"
		}, RGB(255, 255, 255));
	lives[2].SetTopLeft(76, 550);
